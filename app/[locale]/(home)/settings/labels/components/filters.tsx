...
interface LabelFiltersProps {
  nameQuery: string;
  typeFilter: LabelType | "";
  onSearchChange: (nameQuery: string, typeFilter: LabelType | "") => void;
  onSearchReset: () => void;
}
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1">
          <Select
            ...
            onValueChange={(value) => setLocalTypeFilter(value as LabelType | "")}
          >
            <SelectTrigger className="w-full">
              <SelectValue placeholder={commonT("type")} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="battalion">{t("battalion")}</SelectItem>
